...
import DepartmentChart from './Chart';
            ...
            <Grid container spacing={4}>
                {loading ? (
                    ...
                    <>
                                ...
                                <Grid item xs={12} sm={6}>
                                    <Card sx={{ height: '100%', boxShadow: 5, bgcolor: '#4caf50', borderRadius: 2 }}>
                                        <CardContent>
                                            ...
                                            <Typography variant="h4" sx={{ color: '#388e3c', fontWeight: 'bold' }}>{dashboardData.maleCount}</Typography>
                                        </CardContent>
                                    </Card>
                                </Grid>
                                ...
                                <Grid item xs={12} sm={6}>
                                    <Card sx={{ height: '100%', boxShadow: 5, bgcolor: '#f06292', borderRadius: 2 }}>
                                        <CardContent>
                                            ...
                                            <Typography variant="h4" sx={{ color: '#d81b60', fontWeight: 'bold' }}>{dashboardData.femaleCount}</Typography>
                                        </CardContent>
                                    </Card>
                                </Grid>
                                ...
                                <Grid item xs={12} sm={6}>
                                    <Card sx={{ height: '100%', boxShadow: 5, bgcolor: '#f1f8e9', borderRadius: 2 }}>
                                        <CardContent>
                                            ...
                                            <Typography variant="h4" sx={{ color: '#1b5e20', fontWeight: 'bold' }}>{dashboardData.leaveSummary.totalLeaves}</Typography>
                                        </CardContent>
                                    </Card>
                                </Grid>
                                ...
                                <Grid item xs={12} sm={6}>
                                    <Card sx={{ height: '100%', boxShadow: 5, bgcolor: '#e8f5e9', borderRadius: 2 }}>
                                        <CardContent>
                                            ...
                                            <Typography variant="h4" sx={{ color: '#1b5e20', fontWeight: 'bold' }}>{dashboardData.leaveSummary.approved}</Typography>
                                        </CardContent>
                                    </Card>
                                </Grid>
                                ...
                                <Grid item xs={12} sm={6}>
                                    <Card sx={{ height: '100%', boxShadow: 5, bgcolor: '#ffecb3', borderRadius: 2 }}>
                                        <CardContent>
                                            ...
                                            <Typography variant="h4" sx={{ color: '#bf360c', fontWeight: 'bold' }}>{dashboardData.leaveSummary.pending}</Typography>
                                        </CardContent>
                                    </Card>
                                </Grid>
                                ...
                                <Grid item xs={12} sm={6}>
                                    <Card sx={{ height: '100%', boxShadow: 5, bgcolor: '#ffcdd2', borderRadius: 2 }}>
                                        <CardContent>
                                            ...
                                            <Typography variant="h4" sx={{ color: '#b71c1c', fontWeight: 'bold' }}>{dashboardData.leaveSummary.rejected}</Typography>
                                        </CardContent>
                                    </Card>
                                </Grid>
                            </Grid>
                        ...
                        <Grid item xs={12} md={6}>
                            <Card sx={{ height: '500px', boxShadow: 5, borderRadius: 2 }}>  {/* Reduced card height */}
                                <CardContent sx={{ height: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
                                    <DepartmentChart /> {/* The chart will now take less space */}
                                </CardContent>
                            </Card>
                        </Grid>
