...
const axiosInstance = axios.create({
    baseURL: process.env.NEXT_PUBLIC_BASE_PATH || 'http://localhost:4000',
    headers: {
...
export const createOrder = async (amount) => axiosInstance.post('/api/payment/order', { amount });
export const verifyPayment = async (paymentDetails) => axiosInstance.post('/api/payment/verify', paymentDetails);
